...
/* ──────────────────────────────────────────────────────────────────────────────
   Mercado da Madeira — PRODUCT CONFIG

   Files live in /public/GLB/mercadodamadeira/
   ────────────────────────────────────────────────────────────────────────────── */
const products = [
  {
    name: "Mesa Centro Cubic",
    glbUrl: "/GLB/mercadodamadeira/Cubic Coffee Table.glb",
    posterUrl: "",
    iosSrc: "",
  },
  {
    name: "Mesa de Jantar Circle",
    glbUrl: "/GLB/mercadodamadeira/Circle Dining Table.glb",
    posterUrl: "",
    iosSrc: "",
  },
  {
    name: "Mesa Timber Circular",
    glbUrl: "/GLB/mercadodamadeira/Circular Timber Table.glb",
    posterUrl: "",
    iosSrc: "",
  },
  {
    name: "Mesa Palm",
    glbUrl: "/GLB/mercadodamadeira/Palm Table.glb",
    posterUrl: "",
    iosSrc: "",
  },
  {
    name: "Banco Drum",
    glbUrl: "/GLB/mercadodamadeira/Banco Drum.glb",
    posterUrl: "",
    iosSrc: "",
  },
  {
    name: "Banco Lino",
    glbUrl: "/GLB/mercadodamadeira/Lino Bank.glb",
    posterUrl: "",
    iosSrc: "",
  },
] as const;
...
export default function MercadodamadeiraPage() {
              ...
              <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-muted-foreground max-w-xl">
                    Solid wood tables and furniture made in Portugal using
                    traditional carpentry methods.
                  </p>
                </div>
                <a
                    href="https://www.mercadodamadeira.pt"
                    target="_blank"
